      ...
      for (const item of featured) {
        ...
        if (staticItem) {
          batch.set(ref, {
            ...
            brand: staticItem.brand || 'New Step',
            subtitle: staticItem.subtitle || '',
            category: staticItem.category,
            categoryLabel: staticItem.categoryLabel,
            colour: staticItem.colour,
            colourway: staticItem.colourway || [],
            price: staticItem.price,
            compareAtPrice: staticItem.compareAtPrice || null,
            images: (staticItem.images || []).map((img) => img === '/images/hero.jpg' ? '/images/p10.jpg' : img),
            description: staticItem.description || '',
            details: staticItem.details || [],
            variants: staticItem.variants || [],
            rating: staticItem.rating || 4.8,
            reviewCount: staticItem.reviewCount || 12,
            visibility: 'published',
            ...updatePayload,
          }, { merge: true })
        } else {
